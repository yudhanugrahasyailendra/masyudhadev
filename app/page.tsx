          ...
          <div className="exp-layout">
            <div>
              ...
              <div style={{ marginTop: '32px', paddingLeft: '26px' }}>
                <Link className="btn-circuit" href="https://drive.google.com/file/d/1B2ZIl_Tgshi_Paim4Co95DyofxKyq0oO/view?usp=sharing" target="_blank" rel="noopener noreferrer">
