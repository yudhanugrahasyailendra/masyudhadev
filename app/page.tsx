          ...
          <div className="exp-layout">
            <div>
              ...
              <div style={{ marginTop: '32px', paddingLeft: '26px' }}>
                <Link className="btn-circuit" href="https://drive.google.com/file/d/1VG5nSpsak0hqov32SwI22UGuE0FIRoks/view?usp=sharing" target="_blank" rel="noopener noreferrer">
