    ...
    <section id="projects" style={{ minHeight: '100vh', paddingTop: '140px' }}>
      <div className="wrap">
        ...
        <div className="projects-grid">
          ...
          <div className="project-card">
            <h3>SMP Negeri 1 Tinggimoncong</h3>
          ...
          <div className="project-card">
            ...
            <p>An integrated educational website for MA Bindu to facilitate digital information sharing among teachers, students, and parents.</p>
